...
export const EFFECT_PRESETS: EffectPreset[] = [
  {
    id: 'cinematic',
    label: 'Cinematic',
    description: 'Contraste +, saturação +, leve escurecimento',
    filter: 'contrast(1.1) saturate(1.2) brightness(0.95)',
  },
  {
    id: 'vintage',
    label: 'Vintage',
    description: 'Sépia + contraste reduzido + escurecimento',
    filter: 'sepia(0.4) contrast(0.9) brightness(0.9)',
  },
  {
    id: 'neon',
    label: 'Neon',
    description: 'Alto contraste, saturação intensa, brilho elevado',
    filter: 'contrast(1.3) saturate(1.5) brightness(1.1)',
  },
  {
    id: 'darkmatte',
    label: 'Dark Matte',
    description: 'Contraste reduzido, brilho baixo, dessaturação',
    filter: 'contrast(0.85) brightness(0.8) saturate(0.7)',
  },
  {
    id: 'bw',
    label: 'Preto e Branco',
    description: 'Saturação zero + contraste extra',
    filter: 'grayscale(1) contrast(1.1)',
  },
  {
    id: 'warm',
    label: 'Quente',
    description: 'Sépia leve + saturação elevada',
    filter: 'sepia(0.3) saturate(1.3)',
  },
  {
    id: 'cold',
    label: 'Frio',
    description: 'Matiz invertida + dessaturação + brilho',
